...
def check():
    ...
    StatusPageURI = (
        "https://api.tfl.gov.uk/StopPoint/Mode/tube,cable-car,bus,dlr,national-rail,overground,river-bus,tflrail,tram/Disruption?includeRouteBlockedStops=True&app_id=%s&app_key=%s"
